...
def test_pipeline_model_dump_contains_required_ui_runtime_fields() -> None:
    ...
    # For correlation dataset, the main finding should include the correlation value and be specific
    assert payload["main_finding"] == "A strong correlation was detected between x_value and y_value (corr=1)."
