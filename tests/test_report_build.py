...
def test_report_contains_product_facing_output_fields() -> None:
    ...
    # The main finding prioritizes quantified data quality issues over other verified insights
    assert report.main_finding == "Data quality attention needed: Missing values detected in 1 column (1 cell total)."
